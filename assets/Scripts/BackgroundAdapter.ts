...
export default class BackgroundAdapter extends cc.Component {
    ...
    update(){
    //       var check=  cc.view.getFrameSize() 
    //     if (check.width>check.height) {
    //         this.node.setContentSize(cc.view.getCanvasSize().height,cc.view.getCanvasSize().width)
    //   }
    //    else {
    //     this.node.setContentSize(cc.view.getCanvasSize().width,cc.view.getCanvasSize().height)
    //    }
